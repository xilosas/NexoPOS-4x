        ...
        <div id="dashboard-body" class="overflow-hidden flex flex-auto">
            ...
            <div class="flex flex-auto flex-col overflow-hidden bg-gray-200">
                ...
                <div class="p-2 text-xs flex justify-end text-gray-500">
                    {!! 
                        Hook::filter( 'ns-footer-signature', sprintf( __( 'You\'re using <a tager="_blank" href="%s" class="hover:text-blue-400 mx-1 inline-block">Metal Scrap %s</a>' ), 'https://pos.kopetrotrading.com.my', config( 'nexopos.version' ) ) )
                    !!}
                </div>
            </div>
        </div>
